---
name: al-folio-gem-routing
description: Use before routing any runtime/layout/include/tag/filter/feature-behavior change in this al-folio v1.x site — explains the sibling-gem architecture, the wrapper-to-tag delegation map, and which al_folio_core-owned file corresponds to which plugin gem.
---

# al-folio Gem Routing
